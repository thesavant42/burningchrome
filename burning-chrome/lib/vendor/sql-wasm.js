...
let initSqlJsPromise = undefined;

let initSqlJs = function (moduleConfig) {
  if (initSqlJsPromise) {
  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
    ...
    let Module = typeof moduleConfig !== 'undefined' ? moduleConfig : {};

    // EMCC only allows for a single onAbort function (not an array of functions)
    // So if the user defined their own onAbort function, we remember it and call it
    let originalOnAbortFunction = Module['onAbort'];
    ...
    f.onRuntimeInitialized = function () {
      ...
      function b(g, l) {
        for (var n = [], t = 0; t < g; t += 1) {
          ...
          if (1 === z || 2 === z) w = rc(w);
            ...
            w = tc(z);
            z = uc(z);
            for (var N = new Uint8Array(w), L = 0; L < w; L += 1)
              N[L] = p[z + L];
            w = N;
          } else w = null;
          n.push(w);
      ...
      var h = x(4),
        k = f.cwrap,
        r = k('sqlite3_open', 'number', ['string', 'number']),
        y = k('sqlite3_close_v2', 'number', ['number']),
        ...
        F = k('sqlite3_changes', 'number', ['number']),
        H = k('sqlite3_prepare_v2', 'number', [
          'number',
          'string',
          'number',
          'number',
        ...
        vc = k('sqlite3_normalized_sql', 'string', ['number']),
        ...
        xc = k('sqlite3_bind_double', 'number', ['number', 'number', 'number']),
        yc = k('sqlite3_bind_int', 'number', ['number', 'number', 'number']),
        zc = k('sqlite3_bind_parameter_index', 'number', ['number', 'string']),
        Ac = k('sqlite3_step', 'number', ['number']),
        Bc = k('sqlite3_errmsg', 'string', ['number']),
        Cc = k('sqlite3_column_count', 'number', ['number']),
        Dc = k('sqlite3_data_count', 'number', ['number']),
        Ec = k('sqlite3_column_double', 'number', ['number', 'number']),
        sb = k('sqlite3_column_text', 'string', ['number', 'number']),
        Fc = k('sqlite3_column_blob', 'number', ['number', 'number']),
        Gc = k('sqlite3_column_bytes', 'number', ['number', 'number']),
        Hc = k('sqlite3_column_type', 'number', ['number', 'number']),
        Ic = k('sqlite3_column_name', 'string', ['number', 'number']),
        Jc = k('sqlite3_reset', 'number', ['number']),
        Kc = k('sqlite3_clear_bindings', 'number', ['number']),
        Lc = k('sqlite3_finalize', 'number', ['number']),
        tb = k(
        ...
        qc = k('sqlite3_value_type', 'number', ['number']),
        tc = k('sqlite3_value_bytes', 'number', ['number']),
        sc = k('sqlite3_value_text', 'string', ['number']),
        uc = k('sqlite3_value_blob', 'number', ['number']),
        rc = k('sqlite3_value_double', 'number', ['number']),
        nc = k('sqlite3_result_double', '', ['number', 'number']),
        lb = k('sqlite3_result_null', '', ['number']),
        oc = k('sqlite3_result_text', '', [
          'number',
          'string',
          'number',
          'number'
        ]),
        pc = k('sqlite3_result_blob', '', [
          'number',
          'number',
          'number',
          'number'
        ]),
        mc = k('sqlite3_result_int', '', ['number', 'number']),
        Aa = k('sqlite3_result_error', '', ['number', 'string', 'number']),
      ...
      c.prototype.getColumnNames = function () {
        for (var g = [], l = Cc(this.La), n = 0; n < l; n += 1)
          g.push(Ic(this.La, n));
        return g;
      };
        ...
        try {
          ...
          for (g = []; 0 !== m(z, 'i8'); ) {
            ...
            if (0 !== L) {
              let K = null;
              w = new c(L, this);
              for (null != l && w.bind(l); w.step(); )
                null === K &&
                  ((K = { columns: w.getColumnNames(), values: [] }),
                  g.push(K)),
      ...
      e.prototype.create_function = function (g, l) {
        Object.prototype.hasOwnProperty.call(this.Na, g) &&
          (ua(this.Na[g]), delete this.Na[g]);
        let n = xa(function (t, w, z) {
          w = b(w, z);
          try {
      ...
      e.prototype.create_aggregate = function (g, l) {
        ...
        Object.hasOwnProperty.call(this.Na, g) &&
          (ua(this.Na[g]), delete this.Na[g]);
        l = g + '__finalize';
        Object.hasOwnProperty.call(this.Na, l) &&
          (ua(this.Na[l]), delete this.Na[l]);
        let N = xa(function (K, O, Ua) {
            let X = ub(K, 1);
    ...
    let Ja = f.print || console.log.bind(console),
      B = f.printErr || console.error.bind(console);
    Object.assign(f, ya);
    ya = null;
        ...
        Ga: {
          ...
          rename(a, b, c) {
            if (R(a.mode)) {
              ...
              if (d) for (let e in d.Ia) throw new P(55);
            }
    ...
    function Ub() {
      for (let a = 0; 4096 >= a; a++) if (!Jb[a]) return a;
      throw new P(33);
    }
    function U(a) {
      a = Jb[a];
    ...
    function ka(a, b) {
      a = 'string' == typeof a ? T(a, { Sa: !0 }).node : a;
    ...
    var Pc = (a, b) =>
      ...
      Qc = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
      ...
      xa = (a, b) => {
        ...
        try {
          ...
          if ('function' == typeof WebAssembly.Function) {
            ...
            for (
              var h = { parameters: [], results: 'v' == b[0] ? [] : [e[b[0]]] },
                k = 1;
              k < b.length;
              ++k
            )
    ...
    var $c = {
        a: (a, b, c, d) => {
          C(
            `Assertion failed: ${a ? M(q, a) : ''}, at: ` +
              [
                b ? (b ? M(q, b) : '') : 'unknown filename',
                c,
                d ? (d ? M(q, d) : '') : 'unknown function'
              ]
          );
        },
        h: function (a, b) {
        ...
        g: function (a) {
          try {
            let b = U(a).node;
            let c = 'string' == typeof b ? T(b, { Sa: !0 }).node : b;
        ...
        l: function (a, b, c) {
          ...
          let d = new Date(a.getFullYear(), 0, 1).getTimezoneOffset();
          D[(c + 32) >> 2] =
        ...
        s: (a, b, c) => {
          function d(y) {
            return (y = y.toTimeString().match(/\(([A-Za-z ]+)\)$/))
              ? y[1]
              : 'GMT';
          }
      ...
      Z = (function () {
        ...
        if (f.instantiateWasm)
          try {
            ...
            return (
              B(`Module.instantiateWasm callback failed with error: ${c}`), !1
            );
          }
        db(b, function (c) {
          a(c.instance);
    ...
    f._sqlite3_prepare_v2 = (a, b, c, d, e) =>
      (f._sqlite3_prepare_v2 = Z.N)(a, b, c, d, e);
    ...
    f._sqlite3_result_double = (a, b) =>
      (f._sqlite3_result_double = Z.ba)(a, b);
    f._sqlite3_result_error = (a, b, c) =>
      (f._sqlite3_result_error = Z.ca)(a, b, c);
    f._sqlite3_result_int = (a, b) => (f._sqlite3_result_int = Z.da)(a, b);
    f._sqlite3_result_int64 = (a, b, c) =>
      (f._sqlite3_result_int64 = Z.ea)(a, b, c);
    ...
    f._sqlite3_aggregate_context = (a, b) =>
      (f._sqlite3_aggregate_context = Z.ha)(a, b);
    ...
    var ea = (f._malloc = (a) => (ea = f._malloc = Z.ya)(a)),
      ca = (f._free = (a) => (ca = f._free = Z.za)(a));
    f._RegisterExtensionFunctions = (a) =>
      (f._RegisterExtensionFunctions = Z.Ba)(a);
    ...
    f.stackRestore = sa;
    f.cwrap = (a, b, c, d) => {
      let e = !c || c.every((h) => 'number' === h || 'boolean' === h);
      return 'string' !== b && e && !d
        ? f['_' + a]
        : function () {
