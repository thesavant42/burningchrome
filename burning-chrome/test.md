# The Plugin does not load XML from the context menu any longer

- This used to work, but then a change in how xml handling occurs seems to have interrupted this function.
